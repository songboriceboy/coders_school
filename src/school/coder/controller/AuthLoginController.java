...
public class AuthLoginController {
    ...
    public ModelAndView github(HttpServletRequest request,String code)
    {
        ...
        String me = CommonUtil.sendPost
                ("https://github.com/login/oauth/access_token?client_id="+client_id+"&client_secret="+client_secret+"&code="+code+"&redirect_uri=http://www.songbo.info/testgit/auth/github",null);
